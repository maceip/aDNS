...
The final repeat includes the corrected TSIG work transaction confirmation through
the public CCF interface and the exporter allowlist for those actual confirmation
responses. The [preceding 82-test snapshot](../python-contract-before-interface-fix-20260913/README.md)
is preserved with its original source hashes. The complete frozen/live source set
matched after this final repeat too; no production input changed.
