...
These public templates and policies describe a superseded candidate. The assembled operator test later exposed a mixed-TTL signing defect; this primary must not be deployed. A corrected image and new CCE policy are required. They are
